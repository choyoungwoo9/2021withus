...
public class GvhelpController {
    ...
    public @ResponseBody List<GetGvhelpResponseDTO> gvhelp (
        ...
        System.out.println("메소드 : get /gvhelp board_lat : "+board_lat+"board_lng : "+board_lng+"board_addr : "+board_addr+"board_region1Depth : "+board_region1Depth+"board_region2Depth : "+board_region2Depth);
