...
public interface INdhelpDAO {
    ...
    public int ndhelpdetail_put(String board_id, String board_writer, String board_title, String board_content, String board_category, LocalDateTime board_start_date, LocalDateTime board_end_date, String board_lat, String board_lng, String board_addr, String board_region1Depth, String board_region2Depth, String board_ndid);
    //도움요청 글 작성하기(작성후 확인버튼 클릭)
    public int ndhelp_write(String board_writer, String board_title, String board_content, String board_category, LocalDateTime board_start_date, LocalDateTime board_end_date, String board_lat, String board_lng, String board_addr, String board_region1Depth, String board_region2Depth, String board_ndid);
    //도움요청 글 삭제하기
